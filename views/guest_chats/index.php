...
<div class="container py-5 px-4">
  ...
  <header class="text-center">
    ...
    <p class="text-white lead mb-4">
        ...
        <u><?php echo $username;?> Онлайн</u></a>
    </p>
...
<ul id="messages"><?php echo $chat_history;?></ul>
      ...
      <form action="#" method="post" class="bg-light">
        <div class="input-group">
          ...
          <input type="text" name="chat_message" placeholder="Зарегистрируйтесь" aria-describedby="button-addon2" class="form-control rounded-0 border-0 py-4 bg-light" readonly>
